...
CrossIDHAL - Chargement de votre fichier CSV équivalent DOIAC :
<br><br>
<?php
...
<form enctype="multipart/form-data" action="CrossDOIAC_CSV_upload.php" method="post" accept-charset="UTF-8">
<p class="form-inline">
<label for="CSV_DOIAC">CSV DOIAC</label> : <input class="form-control" id="CSV_DOIAC" style="height: 25px; font-size: 90%; padding: 0px;" name="CSV_DOIAC" type="file" /><br/>
