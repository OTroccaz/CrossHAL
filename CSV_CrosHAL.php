...
<form enctype="multipart/form-data" action="CSV_CrosHAL_upload.php" method="post" accept-charset="UTF-8">
<p class="form-inline">
<label for="CSV_CrosHAL">CSV CrosHAL</label> : <input class="form-control" id="CSV_CrosHAL" style="height: 25px; font-size: 90%; padding: 0px;" name="CSV_CrosHAL" type="file" /><br/>
