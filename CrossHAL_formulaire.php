												...
												if (isset($_POST["valider"]) || isset($_POST["suite"]) || isset($_POST["retour"])) {
													...
													if (isset($_POST["vnpOA"]) && $_POST["vnpOA"] == "oui") {$vnpOA = htmlspecialchars($_POST["vnpOA"]);$opt1 = "oui";}else{$vnpOA = "non";}
													if (isset($_POST["lanOA"]) && $_POST["lanOA"] == "oui") {$lanOA = htmlspecialchars($_POST["lanOA"]);$opt1 = "oui";}else{$lanOA = "non";}
													if (isset($_POST["finOA"]) && $_POST["finOA"] == "oui") {$finOA = htmlspecialchars($_POST["finOA"]);$opt1 = "oui";}else{$finOA = "non";}
													if (isset($_POST["anrOA"]) && $_POST["anrOA"] == "oui") {$anrOA = htmlspecialchars($_POST["anrOA"]);$opt1 = "oui";}else{$anrOA = "non";}
													if (isset($_POST["melOA"]) && $_POST["melOA"] == "oui") {$melOA = htmlspecialchars($_POST["melOA"]);$opt1 = "oui";}else{$melOA = "non";}
                                                ...
                                                Identifiant alphabétique auteur HAL
													...
													<div class="form-group row mb-1">
														<div class="form-group col-sm-2">
															...
															if ($moisactuel >= 9) {$i = date('Y', time())+1;}else{$i = date('Y', time());}
                                                            ...
                                                            <div id="collapseOne" class="collapse p-2" aria-labelledby="headingOne" data-parent="#accordionChoix">
																<div class="card-body">
																		<div class="border border-grey rounded p-2 mb-2">
																				...
																				<?php
																				if (isset($doiOA) && $doiOA == "oui") {$OAdoi = " checked";}else{$OAdoi = "";}
																				if (isset($revOA) && $revOA == "oui") {$OArev = " checked";}else{$OArev = "";}
																				if (isset($vnpOA) && $vnpOA == "oui") {$OAvnp = " checked";}else{$OAvnp = "";}
																				if (isset($lanOA) && $lanOA == "oui") {$OAlan = " checked";}else{$OAlan = "";}
																				if (isset($finOA) && $finOA == "oui") {$OAfin = " checked";}else{$OAfin = "";}
																				if (isset($anrOA) && $anrOA == "oui") {$OAanr = " checked";}else{$OAanr = "";}
																				if (isset($melOA) && $melOA == "oui") {$OAmel = " checked";}else{$OAmel = "";}
																				...
																				<div class="form-group row mb-1">
																					...
																					<div class="form-group col-sm-12">
																						<div class="custom-control custom-checkbox">
																							...
																							Cocher tout (Articles - OpenAlex et Pubmed prioritaires)
																							</label>
																						</div>
																					</div>
																				</div>
																				
																				<h4><span class='badge badge-secondary-lighten'>Via OpenAlex (articles) :</span></h4>
																				<div class="form-group row mb-1">
																					<div class="form-group col-sm-3">
																						<div class="custom-control custom-checkbox">
																							<input type="checkbox" id="chk53" class="custom-control-input" onclick="option1();" name="doiOA" value="oui"<?php echo $OAdoi;?>>
																							<label for="chk53" class="custom-control-label">
																							DOI
																							</label>
																						</div>
																					</div>
																					...
																					<div class="form-group col-sm-3">
																						<div class="custom-control custom-checkbox">
																							<input type="checkbox" id="chk54" class="custom-control-input" onclick="option1();" name="revOA" value="oui"<?php echo $OArev;?>>
																							<label for="chk54" class="custom-control-label">
																							Revue
																							</label>
																						</div>
																					</div>
																					...
																					<div class="form-group col-sm-3">
																						<div class="custom-control custom-checkbox">
																							<input type="checkbox" id="chk55" class="custom-control-input" onclick="option1();" name="vnpOA" value="oui"<?php echo $OAvnp;?>>
																							<label for="chk55" class="custom-control-label">
																							Vol/num/Pag
																							</label>
																						</div>
																					</div>
																					...
																					<div class="form-group col-sm-3">
																						<div class="custom-control custom-checkbox">
																							<input type="checkbox" id="chk56" class="custom-control-input" onclick="option1();" name="lanOA" value="oui"<?php echo $OAlan;?>>
																							<label for="chk56" class="custom-control-label">
																							Langue
																							</label>
																						</div>
																					</div>
																					...
																					<div class="form-group col-sm-3">
																						<div class="custom-control custom-checkbox">
																							<input type="checkbox" id="chk57" class="custom-control-input" onclick="option1();" name="finOA" value="oui"<?php echo $OAfin;?>>
																							<label for="chk57" class="custom-control-label">
																							Financement
																							</label>
																						</div>
																					</div>
																					...
																					<div class="form-group col-sm-3">
																						<div class="custom-control custom-checkbox">
																							<input type="checkbox" id="chk58" class="custom-control-input" onclick="option1();" name="anrOA" value="oui"<?php echo $OAanr;?>>
																							<label for="chk58" class="custom-control-label">
																							ANR
																							</label>
																						</div>
																					</div>
																					...
																					<div class="form-group col-sm-3">
																						<div class="custom-control custom-checkbox">
																							...
																							<label for="chk59" class="custom-control-label">
