...
CrossIDHALEnr - Chargement de votre fichier CSV enrichi :
<br><br>
<?php
...
<form enctype="multipart/form-data" action="CrossIDHALEnr_CSV_upload.php" method="post" accept-charset="UTF-8">
<p class="form-inline">
