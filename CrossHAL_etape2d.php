	...
	if (in_array($arrayHAL["response"]["docs"][$cpt]["halId_s"], $HALID_VU) || $arrayHAL["response"]["docs"][$cpt]["docType_s"] == "THESE") {//Ne pas prendre en compte les halId déjà VU ou les thèses
		...
		*/
		...
		if ($actMaj == "ok") {
			...
			$actAffil .= "<center><span id='maj".$halID."'><a target='_blank' href='".$lienMAJ."' onclick='$.post(\"CrossHAL_liste_actions.php\", { halID: \"".$halID."\", action: \"MAJ_AFFIL\", ctb: \"".$ctb."\", domMel: \"".$domMel."\", proDate: \"".$proDate."\", depDate: \"".$depDate."\", team: \"".$team."\" });majok(\"".$halID."\"); majokVu(\"".$halID."\"); '><img alt='MAJ' style='width: 50px;' src='./img/add_grand.png'></a></span></center>";
		}else{
			$actAffil .= "";
		}
		$actions .= $actAffil;
		...
		*/
		...
		//Vu > Conforme
		$textAff .= "<td style='text-align: center;'><span id='Vu".$halID."'><a style=\"cursor:pointer\" onclick='$.post(\"CrossHAL_vu_actions.php\", { halID: \"".$halID."\" }); majokVu(\"".$halID."\"); $.post(\"CrossHAL_liste_actions.php\", { halID: \"".$halID."\", action: \"MAJ_VU\" }); majok(\"".$halID."\"); majokVu(\"".$halID."\");'><img alt='MAJ' style='width: 50px;' src='./img/add_grand.png'></a></span></td>";
		...
		if ($actMaj == "ok") {
			$lienMAJ = "./CrossHAL_Modif.php?action=MAJ&etp=2&Id=".$halID;
			$actStp .= "<center><span id='maj".$halID."'><a target='_blank' href='".$lienMAJ."' onclick='$.post(\"CrossHAL_liste_actions.php\", { halID: \"".$halID."\", action: \"MAJ_STAMP\" });majok(\"".$halID."\"); majokVu(\"".$halID."\");'><img alt='MAJ' style='width: 50px;' src='./img/add_grand.png'></a></span></center>";
		}else{
			$actStp .= "<center><img style='width: 50px;' src='./img/addOK_grand.png'></center>";
		}
		$actions .= $actStp;
		*/
